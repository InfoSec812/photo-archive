...
public class ApiClient {
    ...
    private String bearerAuth_token;
    ...
    public void userLoginWithJson(
            Credentials body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    public void newUserWithJson(
            NewUser body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    public void getUserDetailsByName(
        ...
        Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        if (id == null) throw new NullPointerException("Missing parameter id in path");
    ...
    public void newGroupWithJson(
            NewGroup body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    /**
     * Call deleteGroupById with empty body. 
     * 
     * @param id Parameter id inside path
     * @param handler The handler for the asynchronous request
     */
    ...
    public void addUserToGroup(
        ...
        // Check required params
        if (id == null) throw new NullPointerException("Missing parameter id in path");
        if (userId == null) throw new NullPointerException("Missing parameter userId in path");
    ...
    public void updateImageByIdWithJson(
            String id,
            ImageObject body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        if (id == null) throw new NullPointerException("Missing parameter id in path");
    ...
    public void addTagToPhoto(
        ...
        // Check required params
        if (id == null) throw new NullPointerException("Missing parameter id in path");
        if (tag == null) throw new NullPointerException("Missing parameter tag in path");
    ...
    private void attachBasicAuthSecurity (HttpRequest request, MultiMap cookies) {
        this.addHeaderParam("Authorization", "Basic " + Base64.getEncoder()
            .encode((this.basicAuth_username + ":" + this.basicAuth_password).getBytes()), request);

    }

    private void attachBearerAuthSecurity (HttpRequest request, MultiMap cookies) {
        this.addHeaderParam("Authorization", "Bearer " + bearerAuth_token, request);
    ...
    /**
     * Set username and password for basic http security scheme BasicAuth
     */
    public void setBasicAuthParams(String username, String password) {
        this.basicAuth_username = username;
        this.basicAuth_password = password;
    }
    
    /**
     * Set access token for security scheme BearerAuth
     */
    public void setBearerAuthToken(String token) {
        this.bearerAuth_token = token;
    }
