...
/**
 * getTagsByPhotoId Test
 */
@RunWith(VertxUnitRunner.class)
public class GetTagsByPhotoIdTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getTagsByPhotoId request
        id = null;
        apiClient.getTagsByPhotoId(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
