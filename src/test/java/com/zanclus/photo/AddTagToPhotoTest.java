...
public class AddTagToPhotoTest extends BaseTest {
    ...
    public void test202(TestContext test) {
        ...
        // TODO set parameters for addTagToPhoto request
        id = null;
        tag = null;
        apiClient.addTagToPhoto(id, tag, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
