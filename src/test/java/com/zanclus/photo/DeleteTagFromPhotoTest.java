...
/**
 * deleteTagFromPhoto Test
 */
@RunWith(VertxUnitRunner.class)
public class DeleteTagFromPhotoTest extends BaseTest {
    ...
    public void test202(TestContext test) {
        ...
        // TODO set parameters for deleteTagFromPhoto request
        id = null;
        tag = null;
        apiClient.deleteTagFromPhoto(id, tag, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
