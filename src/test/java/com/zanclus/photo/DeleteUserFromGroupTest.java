...
/**
 * deleteUserFromGroup Test
 */
@RunWith(VertxUnitRunner.class)
public class DeleteUserFromGroupTest extends BaseTest {
    ...
    public void test202(TestContext test) {
        ...
        // TODO set parameters for deleteUserFromGroup request
        id = null;
        userId = null;
        apiClient.deleteUserFromGroup(id, userId, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
